...
## 🎯 Objetivos da Aula
- Compreender o conceito de **vetores** em algoritmos  
- Declarar, inicializar e manipular vetores  
- Aplicar vetores em exemplos práticos  
...
4. Estruturas Repetitivas com Vetores  
5. Exemplos em **Visualg**  

---

## 🔎 O que são Vetores?
- Um **vetor** é uma **coleção de elementos do mesmo tipo**, armazenados de forma sequencial.  
- Cada posição do vetor é identificada por um **índice**.  

---

## ✍️ Declaração de Vetores em Visualg
```algoritmo
var
...
## ✅ Conclusão
- Vetores permitem armazenar **múltiplos valores** do mesmo tipo  
- São essenciais para **organizar e processar dados em sequência**  
- Praticar é fundamental para dominar o uso de vetores 🚀  
